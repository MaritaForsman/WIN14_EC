...
namespace ec.Roadrunner.WebAPI.Controllers
{
    ...
    /// <summary>
    /// Controller for Purpose for specific user
    /// </summary>
    public class PurposeController : ApiController
    {
        private PurposeControllerService _controllerService = new PurposeControllerService();
        ...
        [Route("api/usersettings/purposes/{userid}")]
        [ResponseType(typeof(Purpose))]
        
       public IHttpActionResult GetPurpose(int userid)
       {
       try 
       {
                return Ok(_controllerService.GetPurpose(userid));
       }
       catch (Exception ex)
       {
